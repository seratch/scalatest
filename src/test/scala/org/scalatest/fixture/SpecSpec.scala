...
*/
  ...
  it("should remove trailing space in scope when scope name ends with single space") {
    class SimpleSpec extends Spec with StringFixture {
      object `Testing ` {
        def `should be simple`(fixture: String) {}
        def `should cancel`(fixture: String) { cancel }
        def `should fail`(fixture: String) { fail }
        def `should pending`(fixture: String) { pending }
      }
    }
  ...
  it("should remove trailing space in test text when test text ends with single space") {
    class SimpleSpec extends Spec with StringFixture {
      object `Testing should be` {
        def `cancel `(fixture: String) { cancel }
        def `fail `(fixture: String) { fail }
        def `pending `(fixture: String) { pending }
        def `simple `(fixture: String) {}
      }
    }
