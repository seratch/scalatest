...
/**
 * A sister class to <code>org.scalatest.FreeSpec</code> that can pass a fixture object into its tests.
 *
 * <p>
 ...
 *
 * <p>
 * Class <code>fixture.FreeSpec</code> behaves similarly to class <code>org.scalatest.FreeSpec</code>, except that tests may have a
 ...
 * 
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.FreeSpec</code>:
 * </p>
 * 
 * <ol>
