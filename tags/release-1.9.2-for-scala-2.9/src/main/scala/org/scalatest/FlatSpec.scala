 ...
 * Class <code>FlatSpec</code> is so named because
 * your specification text and tests line up flat against the left-side indentation level, with no nesting needed.
 * </p>
 *
 * <p>
 * <code>FlatSpec</code>'s no-nesting approach contrasts with classes <code>FunSpec</code> and <code>WordSpec</code>, which use nesting
 ...
 * they have less duplicated text at the cost of being a bit challenging to read. Class <code>FlatSpec</code> offers the opposite
