...
trait FreeSpecLike extends Suite { thisSuite =>
  ...
  private def registerTestToRun(specText: String, testTags: List[Tag], methodName: String, testFun: () => Unit) {
    ...
    registerTest(specText, testFun, "itCannotAppearInsideAnotherIt", "FreeSpecLike.scala", methodName, 1, None, None, testTags: _*)
  }
  ...
  private def registerTestToIgnore(specText: String, testTags: List[Tag], methodName: String, testFun: () => Unit) {
    ...
    registerIgnoredTest(specText, testFun, "ignoreCannotAppearInsideAnIt", "FreeSpecLike.scala", methodName, 1, testTags: _*)
  }
  ...
  protected final class FreeSpecStringWrapper(string: String) {
     ...
     */
    def - (fun: => Unit) {
      registerNestedBranch(string, None, fun, "describeCannotAppearInsideAnIt", "FreeSpecLike.scala", "-", 1)
    }
