...
trait FeatureSpecLike extends Suite { thisSuite =>
  ...
  protected def scenario(specText: String, testTags: Tag*)(testFun: => Unit) {
    ...
    registerTest(Resources("scenario", specText), testFun _, "scenarioCannotAppearInsideAnotherScenario", "FeatureSpecLike.scala", "scenario", 2, None, None, testTags: _*)
  }
  ...
  protected def ignore(specText: String, testTags: Tag*)(testFun: => Unit) {
    registerIgnoredTest(Resources("scenario", specText), testFun _, "ignoreCannotAppearInsideAScenario", "FeatureSpecLike.scala", "ignore", 1, testTags: _*)
  }
  ...
  protected def feature(description: String)(fun: => Unit) {
    ...
    registerNestedBranch(description, None, fun, "featureCannotAppearInsideAScenario", "FeatureSpecLike.scala", "feature", 1)
  }
