...
private[junit] class RunNotifierReporter(runNotifier: RunNotifier) extends Reporter {
  ...
  override def apply(event: Event) {
    ...
    event match {
      ...
      case TestSucceeded(ordinal, suiteName, suiteID, suiteClassName, decodedSuiteName, testName, testText, decodedTestName, duration, structureIndex, postEventCount, formatter, location, rerunnable, payload, threadName, timeStamp) => 
