  ...
  object `ContainMatcher ` {
    ...
    object `when use with 'and'` {
      ...
      def `should failed with correctly stack depth and message when first contain failed but second contain passed` {
        ...
        e.message should be (Some("List(1, 2, 3) did not contain the same iterated elements as List(3, 2, 1)"))
      ...
      def `should failed with correctly stack depth and message when first not contain failed but second contain passed` {
        ...
        e.message should be (Some("List(1, 2, 3) contained the same iterated elements as List(1, 2, 3)"))
        e.failedCodeFileName should be (Some("ContainMatcherAndOrSpec.scala"))
        e.failedCodeLineNumber should be (Some(thisLineNumber - 4))
      }
      ...
      def `should failed with correctly stack depth and message when first contain passed but second not contain failed` {
        ...
        e.message should be (Some("List(1, 2, 3) contained the same elements as List(3, 2, 1), but List(1, 2, 3) contained the same iterated elements as List(1, 2, 3)"))
        e.failedCodeFileName should be (Some("ContainMatcherAndOrSpec.scala"))
        e.failedCodeLineNumber should be (Some(thisLineNumber - 4))
      }
    ...
    object `when use with 'or'` {
      ...
      def `should failed with correctly stack depth and message when first not contain failed and second contain failed` {
        ...
        e.message should be (Some("List(1, 2, 3) contained the same iterated elements as List(1, 2, 3), and List(1, 2, 3) did not contain the same elements as List(8, 2, 1)"))
        e.failedCodeFileName should be (Some("ContainMatcherAndOrSpec.scala"))
        e.failedCodeLineNumber should be (Some(thisLineNumber - 4))
      }
      ...
      def `should failed with correctly stack depth and message when first contain failed and second not contain failed` {
        ...
        e.message should be (Some("List(1, 2, 3) did not contain the same iterated elements as List(3, 2, 1), and List(1, 2, 3) contained the same elements as List(3, 2, 1)"))
        e.failedCodeFileName should be (Some("ContainMatcherAndOrSpec.scala"))
        e.failedCodeLineNumber should be (Some(thisLineNumber - 4))
      }
      ...
      def `should failed with correctly stack depth and message when first not contain failed and second not contain failed` {
        ...
        e.message should be (Some("List(1, 2, 3) contained the same iterated elements as List(1, 2, 3), and List(1, 2, 3) contained the same elements as List(3, 2, 1)"))
        e.failedCodeFileName should be (Some("ContainMatcherAndOrSpec.scala"))
        e.failedCodeLineNumber should be (Some(thisLineNumber - 4))
      }
    }
