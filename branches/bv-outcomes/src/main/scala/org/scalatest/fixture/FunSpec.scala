...
/**
 * A sister class to <code>org.scalatest.FunSpec</code> that can pass a fixture object into its tests.
 *
 ...
 * that must be cleaned up afterwords. <em>Note: <code>fixture.FunSpec</code> is intended for use in special situations, with class <code>FunSpec</code> used for general needs. For
 ...
 * 
 * <p>
 * Class <code>fixture.FunSpec</code> behaves similarly to class <code>org.scalatest.FunSpec</code>, except that tests may have a
 ...
 * 
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.FunSpec</code>:
 * </p>
 * 
 * <ol>
